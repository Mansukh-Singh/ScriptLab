...
export default function Home() {
  ...
  return (
    <>
      <div className='banner flex justify-center text-center items-center bg-gray-600 rounded-2xl pt-7 pb-9 mt-5 w-[70vw] h-[35vh] m-auto'>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <div className="flex gap-2">
                <span className='w-36 h-11 text inline-block font-mono font-bold text-4xl'>Jupyter</span>
                <span className='w-40 text inline-block font-mono font-bold text-4xl'>Notebook</span>
              </div>
              <div className="flex gap-2 items-baseline">
                <span className='w-20 text inline-block font-mono font-bold text-4xl'>Java</span>
                <span className='w-30 text inline-block font-mono text-yellow-300 font-bold text-4xl'>Script</span>
              </div>
            </div>
          </div>
          <p className="description text-yellow-100 w-[60vw] p-1 px-4 rounded-lg text-sm shadow-md shadow-black font-mono font-bold">
